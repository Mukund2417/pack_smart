...
def run_recommendation_engine(db: Session, payload: RecommendationInput, user_id: str = None):
    ...
    return {
        ...
        "required_otr": reqs["target_otr_str"],
        "otr": reqs["target_otr_str"],
        "target_wvtr": reqs["target_wvtr_str"],
        "required_wvtr": reqs["target_wvtr_str"],
        "wvtr": reqs["target_wvtr_str"],
        "thickness": reqs["thickness_str"],
        "sealability": reqs["sealability"],
        "map_required": reqs["map_required"],
        "eco_alternative": reqs["eco_alternative"],
        "shelf_life_days": float(desired_days),
        "desired_shelf_life": float(desired_days),
        "chemical_degradation_risk": f"Atmospheric oxygen sensitivity, moisture vapor migration, and microbial decay for {comm_name}.",
